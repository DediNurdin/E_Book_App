...
Color grayColor = Color(0xFFBDBDBD);
Color grayColorSearchFiled = Color(0xFFF8F8F8);
Color greenColor = Color(0xFF09885C);
Color grayColorRecentBook = Color(0xFFAFAFAF);
Color borderColorRecentBook = Color(0xFFF3F3F3);
Color grayColorInfo = Color(0xFFF7F7F7);
...
TextStyle regularText12 =
    GoogleFonts.poppins(color: grayColor, fontSize: 12, fontWeight: regular);
